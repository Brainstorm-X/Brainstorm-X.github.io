...
<div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px; margin: 2em 0;">
  <div style="text-align: center;">
    <img src="/assets/images/lab-logo.png" alt="Object Re-Identification" style="width: 100%; border: 1px solid #eee; border-radius: 4px;">
    <h4 style="color: #2c7fb8; margin-top: 0.5em;">Object Re-Identification</h4>
  </div>
</div>
...
- **Multimodal Medical AI** aims to integrate and analyze diverse types of medical data (e.g., images, clinical notes, genomic data) for improved disease diagnosis, prognosis, and treatment planning. Our work focuses on developing robust and interpretable AI models that can assist healthcare professionals in making more accurate and timely decisions.
